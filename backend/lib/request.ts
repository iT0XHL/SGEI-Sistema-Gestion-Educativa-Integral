...
/**
 * Como `parseBody`, pero tolera un cuerpo vacío o ausente: en ese caso valida
 * un objeto vacío `{}`. Útil para endpoints cuyo body es totalmente opcional
 * (p. ej. cambiar estado de libreta con observación opcional).
 */
