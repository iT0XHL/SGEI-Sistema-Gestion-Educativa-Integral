    ...
    return (
      <div className="p-6 lg:p-8 max-w-6xl mx-auto">
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-10 flex flex-col items-center text-center gap-3">
          ...
          <p className="text-sm font-medium text-slate-600">El horario de tu sección aún no ha sido publicado.</p>
  ...
  return (
    <div className="p-6 lg:p-8 max-w-6xl mx-auto space-y-6">
      <div className="flex items-start justify-between flex-wrap gap-3">
        ...
        <button
          onClick={() => descargarPdf.mutate({ alumnoId: session!.entidadId, nombreArchivo: 'mi_horario.pdf' })}
